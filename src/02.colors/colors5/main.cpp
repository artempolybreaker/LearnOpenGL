...
int main() {
    ...
    Shader lightingShader("./src/02.colors/colors5/shaders/basic.vs", "./src/02.colors/colors5/shaders/basic.fs");
    Shader shaderLightObject("./src/02.colors/colors5/shaders/basic_light.vs", "./src/02.colors/colors5/shaders/basic_light.fs");
